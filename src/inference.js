    ...
    input: [
      {
        ...
        content: [
          {
            type: "input_text",
            text: "You infer habit tracking settings from natural language. Return only valid JSON with keys: name, category, rationale, cadence. cadence must contain targetCount, periodDays, weeklyDays, unit. Preserve any explicit quantity and unit from the user, such as 10 minutes, 5 km, 20 pages, or 3 times. Do not replace those with schedule counts like 7 days or 1 day."
          }
        ]
      },
      {
